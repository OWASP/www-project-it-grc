...
The enterprise version extends this functionality with tools to analyze data generated by the XDR and GRC modules, enabling GPT to offer valuable insights for managing your cybersecurity risks. 

Additionally, we can provide you GPT-powered cybersecurity assistant so you can test this module, please contact me for an OpenAI key. 

We are also working on integrating Llama to further enhance the capabilities of this module.
